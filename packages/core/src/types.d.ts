...
export interface PaymentRail {
    ...
    buildPayload(requirements: PaymentRequirements, signFn: SignFn): Promise<PaymentPayload>;
...
export type SignalingMessageType = "offer" | "answer" | "ice-candidate" | "join" | "joined" | "leave" | "ping" | "pong" | "error";
